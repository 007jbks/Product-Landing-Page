...
prev_button.addEventListener('click',()=>{
 ...
 const heads = document.querySelectorAll('.head');
    ...
    function ToggleColFlagTrue(){
      const root= document.documentElement;
      root.style.setProperty('--slideshow-flag', 1);
    }
    function ToggleColFlagFalse(){
      const root= document.documentElement;
      root.style.setProperty('--slideshow-flag', 0);
    }

const colour1 = document.getElementById('color1');
colour1.addEventListener('click',()=>{
       console.log('Grey (color1) clicked'); // Debug log
    ToggleColFlagFalse();

});

const colour2 = document.getElementById('color2');
colour2.addEventListener('click',()=>{
    console.log('Grey (color2) clicked'); // Debug log
    ToggleColFlagTrue();
});